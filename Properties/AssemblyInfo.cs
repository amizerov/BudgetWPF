 ...
 * -----------------------------------------
 * Ошибки:
 *      1 - Сохранение темы при смене, восстановление сохраненной при открытии проги
 *      2 - Сохранение лайаута таблиц без закрытия
 *      3 - Ордер первого в списке счета всегда растет быстрее других
 * Новые хотелки:
